...
import com.example.jobflow.webRTC.MyPeerConnectionObserver;
import com.example.jobflow.webRTC.WebRTCClient;
...
public class MainRepository implements WebRTCClient.Listener {
    ...
    private MainRepository(String room){
        this.firebaseClient = new FirebaseClient(room);
    }

    private static MainRepository instance;
    public static MainRepository getInstance(String room){
        if (instance == null){
            instance = new MainRepository(room);
        }
        return instance;
    }

    public void login(String room,String username, Context context, SuccessCallBack callBack){
        firebaseClient.login(room,username,()->{
